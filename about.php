...
<head>
	<meta charset="UTF-8">
	<title>Marketimple - About Page</title>
	...
	<link rel="shortcut icon" href="./images/ghf/rsz_111.png" type="image/x-icon">
		...
		<div class="bi-header-content">
			<div class="bi-header-logo-main-menu d-flex align-items-center justify-content-between">
				<div class="brand-logo">
					<a href="index.html"><img src="./images/ghf/11.png" alt="" width="210" ></a>
				</div>
							...
							<ul id="main-nav" class="nav navbar-nav clearfix">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu clearfix">
										...
										<li class="dropdown">
											<a href="serviceui,ux_design.html">Services Details</a>
											<ul class="dropdown-menu clearfix">
												<li><a href="serviceui,ux_design.html" >UI/UX Design</a></li>
												<li><a href="service_digital marketing.html" >Digital Marketing</a></li>
												<li><a href="service_web_devlopment.html" >Web Development</a></li>
												<li><a href="service_3d_animation .html" >3D Animation</a></li>
												<li><a href="service_E-commerce.html" >E-Commerce</a></li>
												<li><a href="service_SEO.html" >SEO</a></li>
											</ul>
										</li>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu clearfix">
										...
										<li class="dropdown">
											<a href="serviceui,ux_design.html">Services Details</a>
											<ul class="dropdown-menu clearfix">
												<li><a href="serviceui,ux_design.html" target="_blank">Brand & Art</a></li>
												<li><a href="serviceui,ux_design.html" target="_blank">Digital Marketing</a></li>
												<li><a href="serviceui,ux_design.html" target="_blank">Web Development</a></li>
												<li><a href="serviceui,ux_design.html" target="_blank">Design & Development</a></li>
												<li><a href="serviceui,ux_design.html" target="_blank">3D Animation</a></li>
												<li><a href="serviceui,ux_design.html" target="_blank">Branding & Ilastration</a></li>
											</ul>
										</li>
										...
										<li class="dropdown">
											...
											<ul class="dropdown-menu clearfix">
												...
												<li><a href="job_project_manager.html" target="_blank">Career Details</a></li>
											</ul>
										</li>
					...
					<div class="sidebar-info-contents headline pera-content">
						<div class="content-inner">
							<div class="sidebar-logo">
								<a href="#"><img src="./images/ghf/11.png" alt="" width="210" ></a>
							</div>
						...
						<div class="bi-about-img-wrapper d-flex">
							<div class="bi-about-img-area1">
								<div class="bi-about-img1 position-relative bi-img-animation">
									<img src="/images/about img/pexels-andrea-piacquadio-920377.jpg" alt="">
								</div>
							...
							<div class="bi-about-img-area2">
								<div class="bi-about-img2 position-relative bi-img-animation">
									<img src="/images/about img/pexels-mart-production-7550298.jpg" alt="">
								</div>
							</div>
						</div>
					</div>
								...
								<div class="col-md-6">
									<div class="bi-about-circle-progress-item">
										<div class="counter-boxed d-flex align-items-center pera-content headline">
											...
											<div class="bi-about-prog-text">
												<h3 class="text-uppercase">Content-Writing </h3>
												<p>( Wireframe )</p>
											</div>
										</div>
									</div>
				...
				<div class="row">
					<div class="col-lg-5">
						<div class="bi-fun-fact-img bi-img-animation">
							<img class="image_item_1" src="/images/about img/pexels-canva-studio-3153199.jpg">
							<img class="image_item_1" src="/images/about img/pexels-canva-studio-3153199.jpg">
						</div>
					</div>
					<div class="col-lg-7">
						<div class="bi-fun-fact-img-2 bi-img-animation">
							<img class="image_item_1" src="/images/about img/pexels-vlada-karpovich-7433822.jpg">
							<img class="image_item_1" src="/images/about img/pexels-vlada-karpovich-7433822.jpg">
						</div>
					</div>
				</div>
					...
					<div class="bi-portfolio-tab-btn-text">
						...
						<div class="bi-portfolio-btn-img-area bi-img-animation">
							<div class="bi-portfolio-btn-img position-relative">
								<img src="/images/about img/pexels-fauxels-3184298.jpg" alt="">
							</div>
						</div>
								...
								<div class="bi-portfolio-item-content">
									<div class="row">
										<div class="col-md-12">
											<div class="bi-portfolio-item position-relative">
												<div class="portfolio-img">
													<img src="/images/about img/pexels-fauxels-3184357.jpg" alt="">
												</div>
												<div class="portfolio-text headline">
													<h3><a href="career.html"><i class="fal fa-link"></i> Work With Us</a></h3>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="bi-portfolio-item position-relative">
												<div class="portfolio-img">
													<img src="/images/about img/pexels-cottonbro-studio-4065158.jpg" alt="">
												</div>
												<div class="portfolio-text headline">
													<h3><a href="career.html"><i class="fal fa-link"></i> Work With Us</a></h3>
												</div>
										...
										<div class="col-md-6">
											<div class="bi-portfolio-item position-relative">
												<div class="portfolio-img">
													<img src="/images/about img/pexels-cottonbro-studio-3205570.jpg" alt="">
												</div>
												<div class="portfolio-text headline">
													<h3><a href="career.html"><i class="fal fa-link"></i> Work With Us</a></h3>
												</div>
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="bi-sponsor-item">
								<img src="./images/rsz_digiron.png">
							</div>
						</div>
						<div class="swiper-slide">
							<div class="bi-sponsor-item">
								<img src="./images/rsz_1nspl.png">
							</div>
						</div>
						<div class="swiper-slide">
							<div class="bi-sponsor-item">
								<img src="./images/rsz_jjn.png">
							</div>
						</div>
						<div class="swiper-slide">
							<div class="bi-sponsor-item">
								<img src="./images/rsz_1puma.png">
							</div>
...
<!-- Start of Footer  section
	...
	<footer id="bi-footer" class="bi-footer-section" data-background="assets/img/bg/footer-bg.jpg">
		<div class="bi-footer-cta position-relative">
			<div class="container">
				<!-- <div class="bi-footer-cta-content headline d-flex align-items-center  justify-content-between flex-wrap" >
					<div class="bi-footer-cta-text"> 
						<h3>Looking for a
						Marketing Partner</h3>
					</div>
					...
					<div class="bi-footer-social">
						<div class="container">
							<div class="bi-footer-social-content ul-li">
								<ul>
									<li><a href="index-4.1.html"><i class=""></i> Home </a></li>
									<li><a href="about.php"><i class=""></i>  About  </a></li>
									
									<li><a href="service.html"><i class=""></i> Services  </a></li>
									<li><a href="contact.html"><i class=""></i> Contact  </a></li>
									<li><a href="terms-condition.html"><i class=""></i> Terms and Condition </a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="container">
							<div class="bi-footer-logo">
								<div class="brand-logo text-center">
									<a ><img src="./images/ghf/11.png" alt="" width="210" ></a>
								</div>
								<div class="logo-mail text-center headline">
									<h3><a >info@marketimple.com</a></h3>
								</div>
							</div>
						</div>
					</div>
					<div class="bi-footer-copyright text-center">
						Copyright 2023 @marketimple
					</div>
				</footer>	
